...
export default function GeneralLegalCasesClient() {
  ...
  return <main className={styles.page}>
    <header className={`${styles.intro} ${buttonStyles.header}`}><p>Dava ve arabuluculuk dosyalarını, duruşmaları ve süreçleri tek ekrandan yönetin.</p><div className={styles.headerActions}><Link className={buttonStyles.button} href="/genel-dava-ve-arabuluculuk/yeni">＋ Yeni Dosya</Link></div></header>
