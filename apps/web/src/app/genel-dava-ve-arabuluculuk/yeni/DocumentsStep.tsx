...
export default function DocumentsStep({ documents, setDocuments, onBack, onSubmit, error, caseId, folderConfig, setFolderConfig }: Props) {
  ...
  return <form className={styles.form} onSubmit={onSubmit}>
    ...
    <button type="button" className={styles.dropzone} onClick={() => chooseFiles()} onDragOver={(event) => event.preventDefault()} onDrop={(event) => { event.preventDefault(); addFiles(event.dataTransfer.files); }}>
