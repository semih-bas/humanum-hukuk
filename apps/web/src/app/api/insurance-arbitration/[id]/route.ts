...
import { getInsuranceCase, InsuranceCaseNotFoundError, updateInsuranceCase } from "@/lib/insurance-arbitration/service";
...
export async function PATCH(request: Request, context: Context) {
  try {
    ...
    const validation = insuranceCaseInputSchema.safeParse(await readJsonBody(request));
