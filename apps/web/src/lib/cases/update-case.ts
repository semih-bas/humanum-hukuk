...
const editableFields = [
  ...
  "preEnforcementInterestAmount", "postEnforcementInterestAmount", "judgmentStatus", "discountAmount",
...
export async function updateCaseFileInTransaction(
  ...
  const nextValues = {
    ...
    preEnforcementInterestAmount: input.preEnforcementInterestAmount,
    postEnforcementInterestAmount: input.postEnforcementInterestAmount,
  ...
  const snapshot: Prisma.InputJsonObject = {
    ...
    preEnforcementInterestAmount: input.preEnforcementInterestAmount.toFixed(2),
    postEnforcementInterestAmount: input.postEnforcementInterestAmount.toFixed(2),
    hasDamageClaim: input.hasDamageClaim,
    hasDepreciationClaim: input.hasDepreciationClaim,
    hasProfitLossClaim: input.hasProfitLossClaim,
    profitLossDays: input.profitLossDays,
