...
const basePayload = {
  ...
  preEnforcementInterestAmount: "0",
  postEnforcementInterestAmount: "0",
    ...
    await prisma.$transaction(async (transaction) => {
      const caseFile = await transaction.caseFile.create({
        data: {
          ...
          preEnforcementInterestAmount: initial.preEnforcementInterestAmount,
          postEnforcementInterestAmount: initial.postEnforcementInterestAmount,
